...
**             This module contains the calculation routines for the CRC-S4
...
/** kau32_Crc32Table:
    ...
    byte
*/
static const CSS_t_UDINT kau32_Crc32Table[256] =
{
                               ...
                               CSS_t_UDINT u32_preset)
{
  ...
  while (u16_len-- != 0U)
  {
    CSS_t_USINT u8_data8 = *pu8_buf++;
    u32_crc =   kau32_Crc32Table[(u32_crc ^ u8_data8) & 0xffU]
              ^ (u32_crc >> 8);
  }
...
unsigned long GetCRC32Ethernet(const void *pStart, int len,
