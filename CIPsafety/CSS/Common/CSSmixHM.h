...
**
**   Workfile: CSSmixHM.h
**    Summary: host to net copy macros for method
**             CSS_H2N_CPY_MTD_HOMOGENEOUS_MIX CSS macros for copying data from
**             host to network considering mixing data from both Safety
**             Controllers.
**
**     Author: A. Kramer
**
...
/* RSM_IGNORE_QUALITY_BEGIN  Notice #1 - Physical line length > 80 characters */
  ...
  #define CSS_MIX_CPY8(pv_dst, pv_src, u16_idx, u16_len)                         \
    if (SAPL_CssProduceEvenBytesClbk())                                          \
    {                                                                            \
      if ((u16_idx) & 0x0001U)                                                   \
      {                                                                          \
        (*(((CSS_t_USINT*)(pv_dst))+(u16_idx))) = 0U;                            \
      }                                                                          \
      else                                                                       \
      {                                                                          \
        ((*(((CSS_t_USINT*)(pv_dst))+(u16_idx))) = (*((CSS_t_USINT*)(pv_src)))); \
      }                                                                          \
    }                                                                            \
    else                                                                         \
    {                                                                            \
...
/* RSM_IGNORE_QUALITY_BEGIN  Notice #1 - Physical line length > 80 characters */
    ...
    #define CSS_MIX_CPY16(pv_dst, pv_src, u16_idx, u16_len)                                    \
      ...
      {                                                                                        \
        if ((u16_idx) & 0x0001U)                                                               \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 0U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                 \
        }                                                                                      \
        else                                                                                   \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 1U)); \
        }                                                                                      \
      }                                                                                        \
      else                                                                                     \
      {                                                                                        \
    ...
    #define CSS_MIX_CPY16(pv_dst, pv_src, u16_idx, u16_len)                                    \
      ...
      {                                                                                        \
        ...
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 1U)); \
        }                                                                                      \
        else                                                                                   \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 0U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                 \
        }                                                                                      \
      }                                                                                        \
      else                                                                                     \
    ...
    #define CSS_MIX_CPY16(pv_dst, pv_src, u16_idx, u16_len)                                                   \
      ...
      {                                                                                                       \
        ...
        {                                                                                                     \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                                \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (CSS_t_USINT)((*(CSS_t_UINT*)(pv_src)) >> 8U);     \
        }                                                                                                     \
        else                                                                                                  \
        {                                                                                                     \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (CSS_t_USINT)((*(CSS_t_UINT*)(pv_src)) & 0x00FFU); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                                \
        }                                                                                                     \
      }                                                                                                       \
      else                                                                                                    \
...
/* RSM_IGNORE_QUALITY_BEGIN  Notice #1 - Physical line length > 80 characters */
    ...
    #define CSS_MIX_CPY32(pv_dst, pv_src, u16_idx, u16_len)                                    \
      ...
      {                                                                                        \
        if ((u16_idx) & 0x0001U)                                                               \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 0U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 2U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                 \
        }                                                                                      \
        else                                                                                   \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 1U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 3U)); \
        }                                                                                      \
      }                                                                                        \
      else                                                                                     \
      {                                                                                        \
    ...
    #define CSS_MIX_CPY32(pv_dst, pv_src, u16_idx, u16_len)                                    \
      ...
      {                                                                                        \
        ...
        {                                                                                      \
          ...
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 1U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 3U)); \
        }                                                                                      \
        else                                                                                   \
        {                                                                                      \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 0U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                 \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = (*(((CSS_t_USINT*)(pv_src)) + 2U)); \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = 0U;                                 \
        }                                                                                      \
      }                                                                                        \
      else                                                                                     \
    ...
    #define CSS_MIX_CPY32(pv_dst, pv_src, u16_idx, u16_len)                                                          \
      ...
      {                                                                                                              \
        if ((u16_idx) & 0x0001U)                                                                                     \
        {                                                                                                            \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+0U)) >> 8U);     \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+1U)) >> 8U);     \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                                       \
        }                                                                                                            \
        else                                                                                                         \
        {                                                                                                            \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+0U)) & 0x00FFU); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+1U)) & 0x00FFU); \
        }                                                                                                            \
      }                                                                                                              \
      else                                                                                                           \
      {                                                                                                              \
    ...
    #define CSS_MIX_CPY32(pv_dst, pv_src, u16_idx, u16_len)                                                          \
      ...
      {                                                                                                              \
        ...
        {                                                                                                            \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+0U)) >> 8U);     \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+1U)) >> 8U);     \
        }                                                                                                            \
        else                                                                                                         \
        {                                                                                                            \
          (*(((CSS_t_USINT*)(pv_dst)) + 0U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+0U)) & 0x00FFU); \
          (*(((CSS_t_USINT*)(pv_dst)) + 1U + (u16_idx))) = 0U;                                                       \
          (*(((CSS_t_USINT*)(pv_dst)) + 2U + (u16_idx))) = (CSS_t_USINT)((*((CSS_t_UINT*)((pv_src))+1U)) & 0x00FFU); \
          (*(((CSS_t_USINT*)(pv_dst)) + 3U + (u16_idx))) = 0U;                                                       \
        }                                                                                                            \
      }                                                                                                              \
      else                                                                                                           \
  ...
  {                                                                                                \
    ...
    {                                                                                              \
      ...
      {                                                                                            \
        ...
        {                                                                                          \
          (*(((CSS_t_USINT*)(pv_dst))+((u16_idx)+u16_i))) = 0U;                                    \
        }                                                                                          \
        else                                                                                       \
        {                                                                                          \
          (*(((CSS_t_USINT*)(pv_dst))+((u16_idx)+u16_i))) = (*(((CSS_t_USINT*)(pv_src)) + u16_i)); \
        }                                                                                          \
      }                                                                                            \
    }                                                                                              \
    else                                                                                           \
...
#else
  #error This file is usable only for copy method CSS_H2N_CPY_MTD_INTERLACE_EVEN
#endif  /*  (CSS_cfg_H2N_COPY_METHOD == CSS_H2N_CPY_MTD_INTERLACE_EVEN) */
