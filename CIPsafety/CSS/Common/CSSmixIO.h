...
**
**   Workfile: CSSmixIO.h
**    Summary: host to net copy macros for method CSS_H2N_CPY_MTD_INTERLACE_ODD
...
#if (CSS_cfg_H2N_COPY_METHOD == CSS_H2N_CPY_MTD_INTERLACE_ODD)
...
#else
  #error This file is usable only for copy method CSS_H2N_CPY_MTD_INTERLACE_ODD
#endif  /*  (CSS_cfg_H2N_COPY_METHOD == CSS_H2N_CPY_MTD_INTERLACE_ODD) */
