...
#define DMA1_Channel7_BASE    (AHBPERIPH_BASE + 0x0080u)
#define DMA2_BASE             (AHBPERIPH_BASE + 0x0400u)
#define DMA2_Channel1_BASE    (AHBPERIPH_BASE + 0x0408)
#define DMA2_Channel2_BASE    (AHBPERIPH_BASE + 0x041C)
#define DMA2_Channel3_BASE    (AHBPERIPH_BASE + 0x0430u)
#define DMA2_Channel4_BASE    (AHBPERIPH_BASE + 0x0444)
#define DMA2_Channel5_BASE    (AHBPERIPH_BASE + 0x0458u)
...
#define  FLASH_ACR_LATENCY                   ((uint8_t)0x07)               /*!< LATENCY[2:0] bits (Latency) *//* TSL 2013-05-15: changed Latency bits from 0x03 to 0x07. */
